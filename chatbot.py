...
def chatbot():
    ...
    model = gen.GenerativeModel(
        ...
        system_instruction="You should only provide answers to questions related to agriculture. Any other question will be said please ask questions related to agriculture. If any problem is asked by the user then the message should be in this format: Reason: explain in short and precise\nsolution: explain in short and precise\ntreatment: explain in short with exact dosage",
    )
    ...
    def text_to_speech(text, lang='en'):
        ...
        tts = gTTS(text=filtered_text, lang=lang)
        audio_fp = BytesIO()
