...
model = genai.GenerativeModel(
    ...
    system_instruction="you should provide output in a layman terms. you should say the name of the plant and disease in 150 words with appropriate prescription.give me treatment method and medicine dosage on your own.write in this format:\nDisease description:in layman terms\nTreatment and Dosage in unit of Fungicide ,you should not say to follow the instruction in the package instead you recomend dosage by researching:in short\nPrevention and precaution:in short"
)
